...
This is a test program for loading, editing, and saving images using both the `Image` class and the (C++/MFC) `CImage` class.
...
## Source Code
If you are interested in the source code, you can get it on BOOTH.

## Download
You can download the latest version from BOOTH:
https://booth.pm/ja/items/8881168
...
## ソースコードについて
ソースコードをご希望の方は、BOOTH にて公開しています。
必要に応じてご利用ください。

## ダウンロード
最新版は BOOTH からダウンロードできます：
https://booth.pm/ja/items/8881168
